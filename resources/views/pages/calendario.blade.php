...
@section('content')
    ...
    <div class="card">
        ...
        <span id="formadd" class="d-none fr" data-url="{{ route('calendarios.store') }}">
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
                @if (!$hidden)
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                            ...
                            <form action="{{ route('calendarios.store') }}" method="POST" id="form">
                                @csrf
                                @method('POST')
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="flush-headingTwo"
                        data-bs-parent="#accordionFlushExample" style="">
                        @include('components.table.calendario')
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
    ...
    <script>
        ...
        function text(...arg) {
            document.querySelector('#codigo').value = arg[0];
            document.querySelector('#data_inicio').value = arg[1];
            document.querySelector('#data_fim').value = arg[2];
            selectDefault(arg[3], 'simestre');
            selectDefault(arg[4], 'tipo');
            document.querySelector('#descricao').innerHTML = arg[5];
            document.querySelector('#span-calendario').innerHTML = arg[6];
            selectDefault(arg[7], 'ano_lectivo_id');
        }
